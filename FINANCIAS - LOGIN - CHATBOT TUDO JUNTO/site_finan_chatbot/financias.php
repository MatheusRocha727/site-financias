        ...
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-md-3 d-grid">
              ...
              <button class="btn btn-primary" id="btnCalcularPoupanca"><i class="bi bi-hourglass-split"></i> Calcular tempo</button>
            </div>
          </div>
          <div class="mt-3">
      ...
      <div class="card shadow-sm">
        ...
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-md-3 d-grid">
              <label class="form-label invisible">.</label>
              <button class="btn btn-warning" id="btnCalcularEmprestimo"><i class="bi bi-cash-coin"></i> Calcular parcelas</button>
            </div>
          </div>
          ...
          <small class="text-secondary d-block mt-2">Observação: simulação educativa. Consulte custos adicionais (IOF, seguros, tarifas) com sua instituição.</small>
        </div>
      </div>
    </section>
    <!-- /Empréstimo -->
